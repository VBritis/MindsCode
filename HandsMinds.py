...
if __name__ == "__main__":
    folder_path = input("Digite o caminho da pasta a ser processada")
    print("Por favor, digite uma opção:")
    time.sleep(1)  # Adiciona um atraso para garantir que o terminal esteja pronto
    x_input = input("Processar frames: 1 \nLimpar pastas: 2\n")
    print(f"Entrada do usuário: {x_input}")
    if x_input == "1":
        main(folder_path)
    elif x_input == "2":
        clean_file(folder_path)
    else:
        print("Entrada inválida. Por favor, digite 1 para processar frames ou 2 para limpar pastas.")
